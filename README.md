...
- Android Studio con el SDK de Android, y/o Xcode para iOS
- Node.js y npm
- Java (requerido por el emulador de Firestore)
...
> **Nota:** sin ejecutar `build_runner` el proyecto no compila, porque la capa de persistencia local depende de código generado.
